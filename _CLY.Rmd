...
- This document provides a detailed explanation of the original replication package. You will learn: 
    + how to automatically generate a __new label__ by keeping / removing certain parts of an existing label with the __`subinstr` command__,
    + how to use a __`local` macro together with `replace` and `append` commands__ in order to loop over a list of variables and store all their corresponding results into a fresh table every time the code is run, 
    + how to create a __beautiful plot with estimates stored in a matrix__, 
    + creating tables with __outreg2__, while adding a few __values for statistical tests__ in the bottom part. 


- __Link to the article__: <a href="https://www.aeaweb.org/articles?id=10.1257/app.20190396" target="_blank">https://www.aeaweb.org/articles?id=10.1257/app.20190396</a> 

- __Link to the original replication package__: <a href="https://www.openicpsr.org/openicpsr/project/116761/version/V2/view?path=%2Fopenicpsr%2F116761%2Ffcr%3Aversions%2FV2.1%2FRep-file-Moz-Input-Subsidy&type=folder&fbclid=IwAR3bVz5SUf8L2eWPPmh6zxY97BOD8K0LHeIwB8rMiwFi7kfVxomJ3suDmb8" target="_blank">Data and Code for Subsidies and the African Green Revolution: Direct Effects and Social Network Spillovers of Randomized Input Subsidies in Mozambique (openicpsr.org)</a>

- Click [here](https://git-link.vercel.app/api/download?url=https%3A%2F%2Fgithub.com%2FSorbonneDevEcon%2FM2-Econometrics-Book%2Fblob%2Fmain%2Fresources%2FCLY%2FDoFile_CLY.do&filename=DoFile_CLY.do) to download the Stata Do-File to replicate the results

- Click [here](https://git-link.vercel.app/api/download?url=https%3A%2F%2Fgithub.com%2FSorbonneDevEcon%2FM2-Econometrics-Book%2Fblob%2Fmain%2Fresources%2FCLY%2FCodebook_CLY_M.pdf&filename=Codebook_CLY_M.pdf) to download the Stata Do-File to replicate the results
...
### Replication of Table 2 (main results) - Regressions with spillover effects
...
#### Replication code for Table 2 (main results of the paper) {-}
